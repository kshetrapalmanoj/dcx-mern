...
class SignUp extends Component {
  ...
  validate = () => {
    ...
    if (!this.state.password) {
      ...
      passwordError = "Password must be at least 8 characters with at least one alphabet,digit and two special characters";
    }
    if (!this.state.email) {
            ...
            <div className="card col-md-6 offset-md-3 offset-md-3" style={{ borderRadius: "10px" }}>
              <div className="card-body">
                <form method="POST" onSubmit={this.stopSubmission}>
                  ...
                  <div className="text-danger" title="full_nameError">{this.state.full_nameError}</div>
                  <br></br>
                  <div>
                  ...
                  <div className="text-danger" title="emailError">{this.state.emailError}</div>
                  <br></br>
                  <div>
                  ...
                  <div className="text-danger" title="passwordError">{this.state.passwordError}</div>
                  <br></br>
                  <div>
                  ...
                  <select className="custom-select" name="group" value={this.state.group}
                    ...
                    <option value="" disabled={true} defaultValue={true} title="group">
                    Select group
                  </option>
                    <option >Developer</option>
                  </select>

                  <div className="text-danger"  title="groupError">{this.state.groupError}</div>
                  <br></br>
                  <div className="text-center">
                    <button className="btn btn-outline-success mr-3 btn-sm" title="sign" disabled={!this.state.group}>Submit</button>
